<?php
/**
 * Clase para consultar una lista de facturas a FACe
 *
...
class ConsultaListaFacturasSSPP
{
	...
	public function consultaListaFacturas($facturas)
	{
		...
		try {
			...
			$out = $sc->consultarListadoFacturas($facturas);
